...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, VCC_EN1_Pin|VCC_EN2_Pin|POWER_5V_Pin|ACC_CS_Pin
  ...
  /*Configure GPIO pins : VCC_EN1_Pin VCC_EN2_Pin */
  GPIO_InitStruct.Pin = VCC_EN1_Pin|VCC_EN2_Pin;
