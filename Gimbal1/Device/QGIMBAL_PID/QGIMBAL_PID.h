...
#ifndef QGIMBAL_PID_H
#define QGIMBAL_PID_H
#include <algorithm>
#include <cmath>
...
public:
     ...
     * */
    QGIMBAL_PID(const PID_type PID_type, const float kp, const float ki, const float kd,
     ...
     */
    void set_sum_error(const float sum_error) { QGIMBAL_PID::sum_error = sum_error; }
...
inline float QGIMBAL_PID::calc(const float input) {
